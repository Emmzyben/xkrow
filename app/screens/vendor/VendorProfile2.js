...
const VendorProfile = ({ route, navigation }) => {
  ...
  return (
    <View>
      <View style={{ padding: 20, borderBottomWidth: 1, borderBottomColor: 'rgba(102, 112, 133, 1)',paddingTop:30 }}>
        ...
        <Text style={{ textAlign: 'center', fontSize: 15.3, lineHeight: 18.52, fontWeight: '700', color: '#141414' }}>Professional Profile</Text>
      </View>
      ...
      <View style={styles.bio}>
        <View style={styles.trx}>
          <View>
            <Text style={{ fontSize: 12, fontWeight: '600' }}>Professional's Information</Text>
          </View>
        </View>
        <View style={styles.step1}>
          <View style={styles.step1Under}>
            ...
            <View>
              <Text style={styles.text5}>{personalInfo.businessType || 'Profession Type'}</Text>
              <Text style={styles.text7}>{personalInfo.businessCategory || 'Profession Category'}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.step1}>
          <View style={styles.step1Under}>
            ...
            <View>
              <Text style={styles.text7}>{personalInfo.businessDescription || 'Description'}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.step1}>
          <View style={styles.step1Under}>
            ...
            <View>
              <Text style={styles.text7}>{personalInfo.address || 'Address'}</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View style={styles.bio}>
        <View style={styles.trx}>
          <View>
            <Text style={{ fontSize: 12, fontWeight: '600' }}>Catalog</Text>
          </View>
        </View>
