  ...
  return (
    <ScrollView>
      <View style={localStyles.header}>
        ...
        <Text style={localStyles.headerTitle}>Add to Catalog</Text>
      </View>
      ...
      <View style={styles.maincontainer}>
        ...
        <Text style={styles.text5}>Price (Optional)</Text>
        <TextInput 
          style={styles.input1} 
          placeholder='Enter without comma' 
