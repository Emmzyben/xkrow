...
const ProfProductDetails = ({ navigation }) => {
  ...
  return (
    <View>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.navigate('ProfProfile1')} style={styles.backButton}>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.title}>name: {productData.item_name}</Text>
...
export default ProfProductDetails;
