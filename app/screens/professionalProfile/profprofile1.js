...
import useCreateProfileImage from '../../hooks/useCreateProfileImage2';
import useFetchProfileImage from '../../hooks/useFetchProfileImage2';
import useGetPersonalInfo from '../../hooks/useGetPersonalInfo2';
import useGetProducts from '../../hooks/useGetProducts2';
  ...
  return (
    <ScrollView style={{backgroundColor:'#fff'}}>
      <View style={localStyles.header}>
        ...
        <Text style={localStyles.headerTitle}>Professional profile</Text>
      </View>
<View style={localStyles.bg}>
  ...
  >
    <FontAwesomeIcon icon={faPen} size={18} color='#fff'/>
      ...
      <Text style={styles.businessName}>{personalInfo.businessName || 'Professional Name'}</Text>
      ...
      <View style={styles.bio}>
        <View style={styles.trx}>
          <View>
            <Text style={localStyles.sectionTitle}>Profile information</Text>
          </View>
          <View>
            <TouchableOpacity onPress={() => navigation.navigate('ProfProfile2')}>
        ...
        <View style={styles.step1}>
          <View style={styles.step1Under}>
            ...
            <View>
              <Text style={localStyles.text5}>{personalInfo.businessType || 'Professional Field'}</Text>
              <Text style={localStyles.text7}>{personalInfo.businessCategory || 'Category'}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.step1}>
          <View style={styles.step1Under}>
            ...
            <View >
              <Text style={localStyles.text7}>{personalInfo.businessDescription || 'Description'}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.step1}>
          <View style={styles.step1Under}>
            ...
            <View style={{paddingRight:15}}>
              <Text style={localStyles.text7}>{personalInfo.address || 'Address'}</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View style={styles.bio}>
        <View style={styles.trx}>
          <View>
            <Text style={localStyles.sectionTitle}>Your Portfolio</Text>
          </View>
          <View>
            <TouchableOpacity onPress={() => navigation.navigate('ProfProfile3')}>
              <Text style={localStyles.updateLink}>Add New</Text>
            </TouchableOpacity>
          </View>
        </View><Text>{'\n'}</Text>
        ...
        <View style={localStyles.allProductsContainer}>
          {productsLoading ? (
            ...
            products.map((product) => (
              <TouchableOpacity
                key={product.$id}
                onPress={() => navigation.navigate('ProfProductDetails', { productData: product })}
...
const localStyles = StyleSheet.create({
  ...
  bg:{
    display:'flex',alignItems:'center',justifyContent:'center',backgroundColor:'#62248F'
  }
});

export default ProfProfile1;
